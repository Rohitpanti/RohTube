...
font-weight:500;
cursor:pointer;
bacground-color:${({ theme })=> theme.soft};
...
const handleUpload = async(e) => {
    ...
    try {
        //console.log(inputs);
        const res = await axios.post('http://localhost:8800/api/videos', {...inputs,tags} ,{headers: {Authorization: 'Bearer' },withCredentials : true})
        setOpen(false)
  ...
  return (
    <Container>
        <Wrapper>
            ...
            <Desc type="text" placeholder='Description' rows={8} name='desc' onChange={handleChange}/>
